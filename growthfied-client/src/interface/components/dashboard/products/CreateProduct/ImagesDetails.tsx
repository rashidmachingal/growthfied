...
type ImagesDetaislProps = {
    setProductData: Dispatch<SetStateAction<CreateProductTypes>>
    productData: CreateProductTypes
}

export default function ImagesDetails({ setProductData, productData }: ImagesDetaislProps) {
      ...
      <Div className="flex flex-wrap lg:flex-nowrap gap-3 lg:gap-5">
        <Div className="flex flex-col gap-1 w-full lg:w-[60%] md:mt-3">
          ...
          <InputField
            ...
            className="hidden"
          />
          {productData.temporary_image_urls.image_one === null ? (
            <Label
              htmlFor="image_one"
            ...
            <Div className="relative" >
              <Image
                width={0}
                height={350}
                src={productData.temporary_image_urls.image_one || ""}
                alt="image_one"
        ...
        <Div className="flex flex-col gap-1 w-full lg:w-[50%] md:mt-3">
          ...
          <InputField
            ...
            className="hidden"
          />
          {productData.temporary_image_urls.image_two === null ? (
            <Label
              htmlFor="image_two"
            ...
            <Div className="relative" >
              <Image
                width={0}
                height={350}
                src={productData.temporary_image_urls.image_two || ""}
                alt="image_two"
        ...
        <Div className="flex flex-col gap-1 w-full lg:w-[50%] md:mt-3">
          ...
          <InputField
            ...
            className="hidden"
          />
          {productData.temporary_image_urls.image_three === null ? (
            <Label
              htmlFor="image_three"
              className="bg-gray-100 h-[13rem] md:h-[15rem] w-[100%] flex flex-col items-center justify-center gap-2 rounded-theme  border-gray-400 hover:border-black border-2 cursor-copy"
            >
            ...
            <Div className="relative" >
              <Image
                width={0}
                height={350}
                src={productData.temporary_image_urls.image_three || ""}
                alt="image_three"
                className="w-full h-[13rem] md:h-[15rem] object-center object-cover rounded-[5px] border"
              />
